        ...
        render(){
            ...
            return (
                <View style={styles.timerContainer}>
                    <Text>Here is the main Timer</Text>
                    <Text style={styles.title}>{title}</Text>
                    <Text>{project}</Text>
                    <Text style={styles.elapsedTime}>{elapsedString}</Text>
                    <View style={styles.buttonGroup}>
                        <TimerButton color='blue' onPress={onEditPress} small title='Edit'/>
                        <TimerButton color='blue' onPress={this.handleRemovePress} small title='Remove'/>
